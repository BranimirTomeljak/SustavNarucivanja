	...
	\end{itemize}
		...
		\section{Dijagram komponenti}
			...
			%\textbf{\textit{dio 2. revizije}}\\
			 ...
			 \begin{figure}[H]
			            \includegraphics[width=\textwidth]{slike/komponenti.vpd_1.png} %veličina u odnosu na širinu linije
